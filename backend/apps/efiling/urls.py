...
from apps.efiling.views.payment_objection_views import (
    PaymentObjectionViewSet,
)
...
urlpatterns = [
    ...
    path(
        "payment-objections/reset/",
        PaymentObjectionViewSet.as_view({'post': 'reset'}),
        name="payment-objection-reset",
    ),
    path(
