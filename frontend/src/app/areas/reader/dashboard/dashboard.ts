...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, RouterOutlet, RouterModule, Navbar, Sidebar],
  templateUrl: "./dashboard.html",
  styleUrl: "./dashboard.css",
  // template: `
  //   <div class="d-flex h-100 reader-dashboard">
  //     <div class="sidebar bg-dark text-white p-3 shadow" style="width: 250px;">
  //       <h5 class="mb-4 text-center py-2 border-bottom border-secondary">
  //         Reader Module
  //       </h5>
  ...
  //       <header
  //         class="bg-white border-bottom p-3 d-flex justify-content-between align-items-center shadow-sm"
  //       >
