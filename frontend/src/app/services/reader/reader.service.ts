...
export type ReaderDailyProceedingCase = {
  ...
  /** ISO dates (YYYY-MM-DD) for this case and bench where proceedings were already sent to steno; same case may submit again for another hearing date. */
  hearing_dates_with_steno?: string[];
  can_assign_listing_date: boolean;
};
