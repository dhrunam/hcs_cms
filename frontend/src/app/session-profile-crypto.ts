 ...
 * The passphrase lives in the Angular bundle; this deters casual inspection only.
 */
...
/** Returns opaque base64 string for sessionStorage, or null if passphrase unset. */
...
/** Whether encryption will persist (passphrase configured). */
